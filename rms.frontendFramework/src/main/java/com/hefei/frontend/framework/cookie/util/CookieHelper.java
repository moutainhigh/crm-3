...
//	}
	...
	public static void appendCookieValue(StringBuffer headerBuf, int version,
		...
		if (path != null) {
			...
			if (version == 0) {
				...
				maybeQuote2(version, buf, path, CookieHelper.tspecials2NoSlash,
						false);
			}
		}
	...
	public static int maybeQuote2(int version, StringBuffer buf, String value,
			String literals, boolean allowVersionSwitch) {
	...
	public static boolean isToken(String value, String literals) {
		String tspecials = (literals == null ? CookieHelper.tspecials : literals);
		if (value == null)
			return true;
		int len = value.length();
	...
	public static boolean isToken2(String value, String literals) {
		String tspecials2 = (literals == null ? CookieHelper.tspecials2
				: literals);
		if (value == null)
			return true;
		int len = value.length();
