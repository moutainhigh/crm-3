...
<body>
	<nav class="breadcrumb">
   	...
   	<div class="page-container">
   		<form method="post" action="<%=RmsConstant.RMS_URL%>/salary/company/employee/saveAdjustSalary.do" id="adjustSalaryForm" class="form form-horizontal">
   			<input type="hidden" value="${salaryDTO.id}" id="id" name="id">
   			<input type="hidden" value="${salaryDTO.employeeId}" id="employeeId" name="employeeId">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>员工姓名：</label>
				<div class="formControls col-xs-8 col-sm-9">
					${salaryDTO.employeeName }
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>月基本工资</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input  type="text" class="input-text" value="${salaryDTO.monthlyBaseSalary }" id="monthlyBaseSalary" name="monthlyBaseSalary">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>月奖金</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input  type="text" class="input-text" value="${salaryDTO.monthlyBonus }" id="monthlyBonus" name="monthlyBonus">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>季度奖金</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input  type="text" class="input-text" value="${salaryDTO.quarterlyBonus }" id="quarterlyBonus" name="quarterlyBonus">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>年奖金</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input  type="text" class="input-text" value="${salaryDTO.yearlyBonus }" id="yearlyBonus" name="yearlyBonus">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>生效时间</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="effectTimeStr" id="effectTimeStr" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',minDate:'1950-01-01',maxDate:'2050-01-01'})" 
...
function saveAdjustSalary(){
	document.forms['adjustSalaryForm'].submit();
}
</script>
</html>
