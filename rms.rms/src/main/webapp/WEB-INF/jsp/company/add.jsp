...
<body>
    ...
    <div class="page-container">
		<form method="post" action="<%=RmsConstant.RMS_URL%>/company/create.do" id="createCompanyForm" class="form form-horizontal">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" value="" placeholder="" id="companyName" name="companyName" type="text">
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					...
					<input id="industryIds" type="hidden" name="industryIds" value="" />
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
			  ...
			  　　　　　　</select>
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" value="" placeholder="" id="companyAddress" name="companyAddress" type="text">
				</div>
			</div>
			<!-- 
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" value="" placeholder="" id="companyTel" name="companyTel" type="text">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>法人：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" value="" placeholder="" id="legalPerson" name="legalPerson" type="text">
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" value="" placeholder="" id="usccCode" name="usccCode" type="text">
				</div>
			</div>
			<!-- 
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" value="" placeholder="" id="businessLicensePic" name="businessLicensePic" type="text">
				</div>
			</div>
			 -->
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<textarea rows="10" cols="120" id="companyInfo" name="companyInfo"></textarea>
				</div>
			</div>
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<button onclick="createCompany();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont"></i> 保存</button>
...
function createCompany(){
	document.forms['createCompanyForm'].submit();
}
</script>
</body>
</html>
