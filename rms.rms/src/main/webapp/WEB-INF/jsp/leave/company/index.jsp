	...
	<nav class="breadcrumb">
   	...
   	<div class="page-container">
			<div class="cl pd-5 bg-1 bk-gray ml-20">
				<form method="post" action="<%=RmsConstant.RMS_URL%>/leave/company/search.do" id="leaveSearchForm">
					...
					<div class="row cl">
						<ul class="inline1">
							<li>
					         ...
					         <li>
					            <label class="tjname fw7">员工卡号：</label>
					            <input type="text" name="cardNo" id="cardNo" value="${cardNo}" />
					         </li>
					         <li>
				            	<label class="tjname fw7">请假类型：</label>
				            	<input type="checkbox"  name="leaveType" value="${TYPE_PRIVATE }" >事假
				            	<input type="checkbox"  name="leaveType" value="${TYPE_SICK }" >病假
				            	<input type="checkbox"  name="leaveType" value="${TYPE_ANNUAL }" >年假
				            	<input type="checkbox"  name="leaveType" value="${TYPE_OFF }" >调休
				            	<input type="checkbox"  name="leaveType" value="${TYPE_FUNERAL }" >丧假
				            	<input type="checkbox"  name="leaveType" value="${TYPE_MATERNITY }" >产假 
				            	<input type="checkbox"  name="leaveType" value="${TYPE_MARRIAGE }" >婚假
				            	<input type="checkbox"  name="leaveType" value="${TYPE_PATERNITY }" >陪产假
				            	<input type="checkbox"  name="leaveType" value="${TYPE_OTHER }" >其他
				          	 </li>
						</ul>
					</div>
					<div class="row cl">
						<ul class="inline1">
							 <li>
				          	...
				          	<li>
				            	<label class="tjname fw7">时间范围：</label>
