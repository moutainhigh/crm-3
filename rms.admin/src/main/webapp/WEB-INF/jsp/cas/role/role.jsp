...
<link rel="stylesheet" type="text/css" href="<%=AdminConstants.STAIC_SERVER_URL %>/static/h-ui.admin/css/style.css" />
  ...
  <body>
	<article class="page-container">
    	...
    	<form action="<%=AdminConstants.ADMIN_SERVER_URL %>/cas/role/create.do" method="post" class="form form-horizontal" id="roleForm">
    		<div class="row cl">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>所属公司ID(管理后台不填)</label>
				<div class="formControls col-xs-8 col-sm-9">
					<span class="select-box">
			...
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
					<button type="button" class="btn btn-success radius" id="role-create" name="role-save"><i class="icon-ok"></i> 确定</button>
				</div>
			</div>
		</form> 
      </article>
  ...
  $(document).ready(function(){
	  $("#role-create").click(function(){roleCreateSubmit();});
  });
