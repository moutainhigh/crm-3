...
<html >
  <head>
    ...
    <!-- Le styles -->
    <link href="<%=AdminConstants.STAIC_SERVER_URL %>/css/bootstrap.css" rel="stylesheet">
    <link href="<%=AdminConstants.STAIC_SERVER_URL %>/css/userLogin.css" rel="stylesheet">
    <link href="<%=AdminConstants.STAIC_SERVER_URL %>/css/bootstrap-responsive.css" rel="stylesheet">
  ...
  <body>
    ...
    <c:if test="${not empty returnCode}">
      ...
      <form class="form-signin" action="<%=AdminConstants.ADMIN_SERVER_URL %>/vlogin.do" method= "POST" id="loginForm">
