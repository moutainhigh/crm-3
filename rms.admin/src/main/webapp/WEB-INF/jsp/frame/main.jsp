    ...
    <section class="Hui-article-box">
		<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
			<div class="Hui-tabNav-wp">
				<ul id="min_title_list" class="acrossTab cl">
					<li class="active"><span title="我的桌面" data-href="<%=AdminConstants.STAIC_SERVER_URL %>/welcome.do">我的桌面</span><em></em></li>
				</ul>
			</div>
		...
		<div id="iframe_box" class="Hui-article">
			<div class="show_iframe">
				...
				<iframe scrolling="yes" frameborder="0" src="<%=AdminConstants.ADMIN_SERVER_URL %>/welcome.do"></iframe>
			</div>
		</div>
	</section>
  </body>
