...
function initLocationSelected(){
	var selectedProvValue = $("#selectedProvValue").val();
	var selectedCityValue = $("#selectedCityValue").val();
	var selectedAreaValue = $("#selectedAreaValue").val();
	
//	$("#provinceCode").attr("value",selectedProvValue);
	$("#provinceCode").find("option[value='" +selectedProvValue + "']").attr("selected",true);
	$("#provinceCode").trigger("change");
	
//	$("#cityCode").attr("value",selectedCityValue);
	$("#cityCode").find("option[value='" +selectedCityValue + "']").attr("selected",true);
	$("#cityCode").trigger("change");
	
//	$("#countyCode").attr("value",selectedAreaValue);
	$("#countyCode").find("option[value='" +selectedAreaValue + "']").attr("selected",true);
	$("#countyCode").trigger("change");
}

function doProvAndCityRelation() {
  var city = $("#cityCode");
  var county = $("#countyCode");
  ...
  $.each(cityJson,
    function(i, val) {
      if (val.item_code.substr(0, 2) == $("#provinceCode").val().substr(0, 2) && val.item_code.substr(2, 4) != '0000' && val.item_code.substr(4, 2) == '00') {
        sb.append("<option value='" + val.item_code + "'>" + val.item_name + "</option>");
      }
    });
