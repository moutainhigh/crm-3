...
function initLocationSelected1(){
	var selectedProvValue1 = $("#selectedProvValue1").val();
	var selectedCityValue1 = $("#selectedCityValue1").val();
	var selectedAreaValue1 = $("#selectedAreaValue1").val();
	
	$("#provinceCode1").find("option[value='" +selectedProvValue1 + "']").attr("selected",true);
	$("#provinceCode1").trigger("change");
	
	$("#cityCode1").find("option[value='" +selectedCityValue1 + "']").attr("selected",true);
	$("#cityCode1").trigger("change");
	
	$("#countyCode1").find("option[value='" +selectedAreaValue1 + "']").attr("selected",true);
	$("#countyCode1").trigger("change");
}


function doProvAndCityRelation1() {
  var city = $("#cityCode1");
  var county = $("#countyCode1");
  ...
  $.each(cityJson1,
    function(i, val) {
      if (val.item_code.substr(0, 2) == $("#provinceCode1").val().substr(0, 2) && val.item_code.substr(2, 4) != '0000' && val.item_code.substr(4, 2) == '00') {
        sb.append("<option value='" + val.item_code + "'>" + val.item_name + "</option>");
      }
    });
