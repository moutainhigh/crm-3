...
<html >
  <head>
    ...
    <script src="<%=FrontSampleConstant.STAIC_SERVER_URL %>/js/jquery-1.9.1.min.js"></script>
    <script src="<%=FrontSampleConstant.STAIC_SERVER_URL %>/js/bootstrap.min.js"></script>
    <script src="<%=FrontSampleConstant.STAIC_SERVER_URL %>/js/jquery.validate.js"></script>
