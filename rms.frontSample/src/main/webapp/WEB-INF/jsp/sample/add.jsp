...
<body>
    <div class="page-container">
		<form method="post" action="<%=FrontSampleConstant.FRONTSAMPLE_URL %>/sample/create.do" id="createSampleForm" class="form form-horizontal">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>公司名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" value="" id="type" name="type" type="text">
				</div>
			</div>
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<button onclick="createSample();" class="btn btn-primary radius" type="button"><i class="Hui-iconfont"></i> 保存</button>
...
function createSample(){
	document.forms['createSampleForm'].submit();
}
</script>
</body>
</html>
